        ...
        .map(async (e) => {
            ...
            li.innerHTML = `
                <div class="hidden absolute bottom-0 h-auto w-full bg-white opacity-80 rounded-lg z-10 items-center justify-center flex-col space-y-2 overflow-y-scroll p-2 border-t-2 border-gray-400">
                    ...
                    <a class="text-lg" href="${fetcheddata.link}" target="_blank">${fetcheddata.link}</a>
                    <button class="text-white bg-black h-7 flex items-center justify-center w-auto p-2 rounded-lg">Visit</button>
                </div>
